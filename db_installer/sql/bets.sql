...
CREATE TABLE IF NOT EXISTS `olympiad_bets` (
  ...
  `coins_bet`     SMALLINT UNSIGNED DEFAULT 50 COMMENT 'Monedas arriesgadas (1-1000)',
  `payout`        SMALLINT UNSIGNED DEFAULT 0  COMMENT 'Monedas recibidas si ganó (1-20 × coins_bet)',
